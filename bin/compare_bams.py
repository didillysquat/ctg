...
class CompareSAMS:
    def __init__(self):
        ...
        # print stats
        print(
            f'{self.len_one} proper pairs in {sys.argv[1]}\n'
            f'{self.len_two} proper pairs in {sys.argv[2]}\n'
            f'{self.len_one-self.seqs_in_common} unique proper pairs in {sys.argv[1]}\n'
            f'{self.len_two-self.seqs_in_common} unique proper pairs in {sys.argv[2]}\n'
